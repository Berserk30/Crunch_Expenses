...
public class Constantes {
     ...
     */
    public static final String GET_URL = IP  + "/androidApp/crunch_expenses/web/obtener_gastos.php";
    public static final String INSERT_URL = IP  + "/androidApp/crunch_expenses/web/insertar_gasto.php";
